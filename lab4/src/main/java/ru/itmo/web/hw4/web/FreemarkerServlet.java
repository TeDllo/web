...
public class FreemarkerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String loggedIdString = request.getParameter("logged_user_id");
        if (loggedIdString != null) {
            try {
                request.getSession().setAttribute("logged_user_id", Long.parseLong(loggedIdString));
        ...
        if (loggedId != null) {
            data.put("logged_user_id", loggedId);
        }
